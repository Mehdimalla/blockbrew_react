...
export default function (data) {
  ...
  if (firstName !== undefined) {
    let emptyValidationText = checkEmpty(firstName, strings.FIRST_NAME);
    if (emptyValidationText !== "") {
      return emptyValidationText;
    } else {
      let minLengthValidation = checkMinLength(firstName, 2, strings.FIRST_NAME);
  ...
  if (lastName !== undefined) {
    let emptyValidationText = checkEmpty(lastName, strings.LAST_NAME);
    if (emptyValidationText !== "") {
      return emptyValidationText;
    } else {
      let minLengthValidation = checkMinLength(lastName, 3, strings.LAST_NAME);
      if (minLengthValidation !== "") {
        return minLengthValidation;
      }
    }
  ...
  if (email !== undefined) {
    ...
    let emptyValidationText = checkEmpty(email, strings.EMAIL_ID);
    if (emptyValidationText !== "") {
      return emptyValidationText;
    } else {
  ...
  if (newPassword !== undefined) {
    ...
    if (emptyValidationText !== "") {
      ...
      let minLengthValidation = checkMinLength(
        newPassword,
        8,
        strings.PASSWORD_REQUIRE_EIGHT_CHARACTRES
      );
      if (minLengthValidation !== "") {
        if (newPassword != undefined) {
